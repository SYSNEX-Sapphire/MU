...
namespace SapphireXR_App.WindowServices
{
    ...
    {
        internal static bool Toggle(DeviceConfiguration.OutputCmd1Index index, string title, string message, string currentState, string stateOnTrue, string stateOnFalse)
        {
        ...
        internal static bool OnOff(string onOff, DeviceConfiguration.OutputCmd1Index index, string title)
        {
